...
class CoconutClassifierV3:
    ...
    def predict(
        ...
        # Prepare tensor
        x = torch.FloatTensor(mfcc_seq).unsqueeze(0).to(self.device)  # (1, time, n_mfcc)
...
EXAMPLES:
  ...
  python inference_v3.py --audio path/to/coconut.wav --show_probs
    ...
    parser.add_argument("--model", type=str, default="models/coconut_classifier_v3.pth",
                        help="Path to model .pth file")
    parser.add_argument("--metadata", type=str, default="models/coconut_classifier_v3_metadata.json",
                        help="Path to metadata JSON")
    parser.add_argument("--audio", type=str, help="Audio file for inference")
    parser.add_argument("--samples_dir", type=str, default="samples",
                        help="Directory with sample files")
    parser.add_argument("--random", action="store_true",
                        help="Use random sample")
    ...
    parser.add_argument("--cache_dir", type=str, default=".preprocessed",
    ...
    if args.from_cache:
        ...
        if args.show_probs:
            ...
            print(f"True label: {true_label} {'✓' if pred_label == true_label else '✗'}")
            print("\nClass probabilities:")
